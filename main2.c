...
int main(void)
{
    ...
    GPIO_PORTF_DIR_R |= GPIO_PORTF_PIN1_EN + LED_BLUE;   //Make PF1 as output and PF4 as input by default
    //GPIO_PORTF_DIR_R |= LED_BLUE;
    GPIO_PORTF_DEN_R |= GPIO_PORTF_PIN1_EN + GPIO_PORTF_PIN4_EN + LED_BLUE  ; //enable PF1 and PF4 pins as digital GPIO
